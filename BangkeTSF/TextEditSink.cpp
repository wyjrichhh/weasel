...
STDMETHODIMP BangkeTSF::OnEndEdit(ITfContext* pContext,
...
STDMETHODIMP BangkeTSF::OnLayoutChange(ITfContext* pContext,
                                       TfLayoutCode lcode,
...
BOOL BangkeTSF::_InitTextEditSink(com_ptr<ITfDocumentMgr> pDocMgr) {
