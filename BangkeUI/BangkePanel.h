...
class BangkePanel {
 ...
 private:
  ...
  bangke::Layout* m_layout = NULL;
  bangke::Context& m_ctx;
  bangke::Context& m_octx;
  bangke::Status& m_status;
  bangke::UIStyle& m_style;
  bangke::UIStyle& m_ostyle;
